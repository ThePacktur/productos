# Generated by Django 3.2 on 2024-11-04 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribuidor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='facturas', to='productoApp.distribuidor')),
            ],
        ),
        migrations.CreateModel(
            name='Productos',
            fields=[
                ...
                ('distribuidores', models.ManyToManyField(related_name='productos', to='productoApp.Distribuidor')),
                ('facturas', models.ManyToManyField(related_name='productos', to='productoApp.Factura')),
            ],
        ),
    ]
