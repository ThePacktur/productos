# Generated by Django 3.2 on 2024-12-10 18:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribuidor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='facturas', to='productoApp.distribuidor')),
            ],
        ),
        migrations.CreateModel(
            name='Productos',
            fields=[
                ...
                ('distribuidores', models.ManyToManyField(blank=True, null=True, related_name='productos', to='productoApp.Distribuidor')),
                ('facturas', models.ManyToManyField(blank=True, null=True, related_name='productos', to='productoApp.Factura')),
            ],
        ),
    ]
